            ...
            var geo = new Ext.util.GeoLocation({
                ...
                listeners: {
                    locationupdate: function (geo) {
                        ...
                        var getCouponsURL='https://cumbari.com/DPServer/dpsclientapi/getCoupons?apiVersion=2&token=cumba4now&longitude='+getCurrentLongitude+'&latitude='+getCurrentLatitude+'&clientId='+userClientId+'&lang='+userLanguage+'&batchNo=1&maxNo='+useroffers+'&radiousInMeter='+userRange;
                   
                        var getCategoriesURL ='https://cumbari.com/DPServer/dpsclientapi/getCategories?apiVersion=2&token=cumba4now&categoriesVersion=1&lang='+userLanguage;
 
                        var getBandsURL='https://cumbari.com/DPServer/dpsclientapi/getBrandedCoupons?apiVersion=2&token=cumba4now&longitude='+getCurrentLongitude+'&latitude='+getCurrentLatitude+'&clientId='+userClientId+'&lang='+userLanguage+'&maxNo='+useroffers+'&radiousInMeter='+userRange;
                        ...
                        if(locationLoad==null){
                            ...
                            var sheet = new Ext.Sheet({
                                ...
                                dockedItems: [
                                {
                                    ...
                                    handler:function(){
                                        ...
                                        var useCouponURL= 'https://cumbari.com/DPServer/dpsclientapi/useCoupon?apiVersion=2&token=cumba4now&couponId='+useCouponId+'&storeId='+useCouponStoreId+'&clientId='+userClientId+'&distanceToStore='+useCouponDistanceToStore;
                                        ...
                                        onPagingTap :function(){
                                            db.transaction(function (tx) {
                                                tx.executeSql('SELECT * FROM TEMP_SETTING', [], function (tx, results) {
                                                    ...
                                                    getCoupon.proxy.url= 'https://cumbari.com/DPServer/dpsclientapi/getCoupons?apiVersion=2&token=cumba4now&longitude='+storeLongitude+'&latitude='+storeLatitude+'&clientId='+userClientId+'&lang='+storeLanguage+'&batchNo='+counter+'&maxNo='+offerValue+'&radiousInMeter='+rangeValue;
                                    ...
                                    listeners: {
                                        activate: {
                                            fn: function(){
                                                ...
                                                //                                        db.transaction(function (tx) {
                                                //                                            tx.executeSql('SELECT * FROM TEMP_SETTING', [], function (tx, results) {
                                                //                                                var selectedLat =  results.rows.item(0).latitude;
                                                //                                                var selectedLng =  results.rows.item(0).longitude;
                                                //                                                var currentLatitude = document.getElementById('hidCurrentLatitude').value;
                                                //                                                var currentLongitude = document.getElementById('hidCurrentLongitude').value;
                                                //                                                var R = 6371;
                                                //                                                var latit1=selectedLat;
                                                //                                                var longi1=selectedLng;
                                                //                                                var latit2=currentLatitude;
                                                //                                                var longi2=currentLongitude;
                                                //                                                var dLatit=toRad(latit2-latit1);
                                                //                                                var dLongi=toRad(longi2-longi1);
                                                //                                                var a = Math.sin(dLatit/2) * Math.sin(dLatit/2) +
                                                //                                                Math.sin(dLongi/2) * Math.sin(dLongi/2) * Math.cos(toRad(latit1)) * Math.cos(toRad(latit2));
                                                ...
                                                //
                                                //                                                if(distance >=300){
                                                //                                                    var foundDis =  Ext.getCmp('hotDeals').getStore();
                                                //                                                    foundDis.load();
                                                //                                                }
                                                //                                            })
                                                //                                        });
                                                ...
                                                db.transaction(function (tx) {
                                                    tx.executeSql('SELECT * FROM TEMP_SETTING', [], function (tx, results) {
                                                        ...
                                                        if(selectedUnit=="meter"){
                                                            Ext.getCmp('hotDeals').itemTpl=couponListTpl;
                                                            Ext.getCmp('hotDeals').initComponent();
                                                            Ext.getCmp('hotDeals').refresh();
                                                        }
                                                        else if(selectedUnit=="miles"){
                                                            Ext.getCmp('hotDeals').itemTpl=couponListForMiles;
                                                            Ext.getCmp('hotDeals').initComponent();
                                                            Ext.getCmp('hotDeals').refresh();
                                        ...
                                        itemtap: function(view, index, item, e){
                                            ...
                                            db.transaction(function (tx) {
                                                tx.executeSql('SELECT * FROM TEMP_SETTING', [], function (tx, results) {
                                                    ...
                                                    hotDealStoreViewStatisticsURL="https://cumbari.com/DPServer/dpsclientapi/storeViewStatistic?apiVersion=1&clientId="+userClientId+"&couponViewStatisticList=[{eventTime:"+"\'"+encodeURI(formattedDate)+"\'"+",couponId:"+"\'"+getCouponsId+"\'"+",storeId:"+"\'"+getStoreId+"\'"+",distanceToStore:"+getDistanceToStore+"}]&token=cumba4now";
                                                    ...
                                                    var getCoupon='https://cumbari.com/DPServer/dpsclientapi/getCoupon?apiVersion=2&couponId='+getCouponsId+'&lang='+userLanguage+'&token=cumba4now'
                                   
                                                    var found = jsonHotDealListStore.findRecord("storeId", rec.data.storeId);
                                        ...
                                        itemTap:function(view, index, item, e){
                                            ...
                                            db.transaction(function (tx) {
                                                tx.executeSql('SELECT * FROM TEMP_SETTING', [], function (tx, results) {
                                                    ...
                                                    tempB = encodeURI(tempB);
                                                    tempB =  tempB.replace(/&/,"%26");
                                                    var brandUrl='https://cumbari.com/DPServer/dpsclientapi/getBrandedCoupons?apiVersion=2&token=cumba4now&longitude='+storeLongitude+'&latitude='+storeLatitude+'&clientId='+userClientId+'&lang='+storeLanguage+'&maxNo='+offerValue+'&radiousInMeter='+rangeValue;
                                        ...
                                        handler:function(){
                                            ...
                                            db.transaction(function (tx) {
                                                tx.executeSql('SELECT * FROM TEMP_SETTING', [], function (tx, results) {
                                                    ...
                                                    var storeLongitude    =  results.rows.item(0).longitude;
                                                    var getCoupon =Ext.getCmp('hotDeals').getStore();
                                                    getCoupon.proxy.url= 'https://cumbari.com/DPServer/dpsclientapi/getCoupons?apiVersion=2&token=cumba4now&longitude='+storeLongitude+'&latitude='+storeLatitude+'&clientId='+userClientId+'&lang='+storeLanguage+'&batchNo=1&maxNo='+offerValue+'&radiousInMeter='+rangeValue;
                                                    getCoupon.load();
                                            ...
                                            action : function(e){
                                                ...
                                                db.transaction(function (tx) {
                                                    tx.executeSql('SELECT * FROM TEMP_SETTING', [], function (tx, results) {
                                                        ...
                                                        var getCoupon =Ext.getCmp('hotDeals').getStore();
                                                        var findCouponURL ='https://cumbari.com/DPServer/dpsclientapi/findCoupons?apiVersion=2&latitude='+storeLatitude+'&longitude='+storeLongitude+'&lang='+storeLanguage+'&clientId='+userClientId+'&token=cumba4now&batchNo=1&maxNo='+offerValue+'&radiousInMeter='+rangeValue+'&searchWords='+temp;
                                        ...
                                        onPagingTap :function(){
                                            ...
                                            db.transaction(function (tx) {
                                                tx.executeSql('SELECT * FROM TEMP_SETTING', [], function (tx, results) {
                                                    ...
                                                    getCoupon.proxy.url= 'https://cumbari.com/DPServer/dpsclientapi/getCoupons?apiVersion=2&token=cumba4now&longitude='+storeLongitude+'&latitude='+storeLatitude+'&clientId='+userClientId+'&lang='+storeLanguage+'&batchNo='+catCounter+'&maxNo='+offerValue+'&radiousInMeter='+rangeValue+'&categoriesFilter='+encodeURI(getTitle);
                                                    catCounter++;
                                                    var maxNumbebr =getCoupon.proxy.reader.rawData.MaxNumberReached;
                                        ...
                                        handler: function() {
                                            ...
                                            db.transaction(function (tx) {
                                                tx.executeSql('SELECT * FROM TEMP_SETTING', [], function (tx, results) {
                                                    ...
                                                    getMoreCoupons.proxy.url= 'https://cumbari.com/DPServer/dpsclientapi/getCoupons?apiVersion=2&token=cumba4now&longitude='+storeLongitude+'&latitude='+storeLatitude+'&clientId='+userClientId+'&lang='+storeLanguage+'&batchNo=1&maxNo='+offerValue+'&radiousInMeter='+rangeValue;
                                                    getMoreCoupons.load();
                                            
                                                    var catStoreURL=Ext.getCmp('categories').getStore();
                                                    catStoreURL.proxy.url='https://cumbari.com/DPServer/dpsclientapi/getCategories?apiVersion=1&token=cumba4now&categoriesVersion=1&lang='+storeLanguage;
                                                    catStoreURL.load();
                            ...
                            var Viewport = new Ext.Panel ({
                                ...
                                items: [tabpanel,Panel,brandListPanel,aboutPanel,feedbackPanel,changePositionPanel,settingPanel,detailViewPanel,mapPanel,rangePanel,offerPanel,unitPanel,languagePanel,infoPanel,detailViewMapPanel,moreDealsPanel,endScreen]
                                ,
                                listeners:{
                                        ...
                                        if(exUrl==vars[0]){
                                            ...
                                            if(vars2[0]=="service=getCoupon"){
                                                ...
                                                if(vars2[3]!= undefined){
                                                    ...
                                                    Ext.Ajax.request({
                                                        url:"https://cumbari.com/DPServer/dpsclientapi/getCoupon?apiVersion=2&token=cumba4now&couponId="+getCId[1]+"&lang=ENG&partnerId="+getPId[1]+"&partnerRef="+getPRe[1],
                                                        method: "GET",
                                                        success: function(response, opts) {
                                                                ...
                                                                db.transaction(function (tx) {
                                                                    tx.executeSql('SELECT * FROM TEMP_SETTING', [], function (tx, results) {
                                                                        ...
                                                                        var getCP = new Ext.data.Store({
                                                                            ...
                                                                            proxy:{
                                                                                type: 'ajax',
                                                                                url: "https://cumbari.com/DPServer/dpsclientapi/getCoupon?apiVersion=2&token=cumba4now&couponId="+getCId[1]+"&lang="+selectedLanguage+"&partnerId="+getPId[1]+"&partnerRef="+getPRe[1],
                                                                                reader: new Ext.data.JsonReader({
                                                                                    type: 'json',
                                                                                    root: 'coupon'
                                                                                })
